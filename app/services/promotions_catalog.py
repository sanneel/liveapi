...
GENERATORS: List[dict] = [
    ...
    {"key": "casino_gow_clone", "group": "Casino", "brand": "JBCL",
     ...
     "what": "Clone the GOW journey with new game / per-tier bets / dates",
     "script": "casino_journey.py", "tab": None},
    ...
    {"key": "tournament_pmcl_email", "group": "Comms", "brand": "PMCL",
     "label": "PMCL Tournament email",
     "what": "The email half of the tournament comms",
     "script": "tournament_pmcl_email.py", "tab": None},
