...
_PROMO_TABS = {"overview", "gow", "tournament_pmcl", "tournament_jbcl", "bet_and_get", "journey_cloner", "randomizers", "nc_discount", "scripts", "prediction", "slot_cards", "sport_comms", "comms_builder"}
