...
from app.routes.script_runner import router as script_runner_router
...
app.include_router(script_runner_router)     # /admin/tools/script-runner + PUBLIC /script-runner/*
