// Randomizer console script — Casino Wheel of Fortune — generated 2026-07-02 09:41 UTC
// randomizers: 1: JBCL|CS|WOF|03.07.26
//
...
//      (POST /promo/v2/promo-drafts/randomizer) then fills it (PUT /promo/v2/randomizer/<id>).
...
(async () => {
  ...
  const BRAND = "JBCL";
  const FLOW = "create_put";             // 'create_put' | 'draftid_post'
