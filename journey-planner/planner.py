...
# Generators catalog — every finished promo tool, so a question about Welcome Pack
# or a tournament is answered from the registry instead of invented. Generated by
# journey-cloner/build_generators_catalog.py. Missing file = none advertised.
_GENERATORS_FILE = SCRIPT_DIR.parent / "journey-cloner" / "generators_catalog.json"
GENERATORS_CATALOG = (
    _GENERATORS_FILE.read_text(encoding="utf-8") if _GENERATORS_FILE.exists() else "{}"
)
...
SYSTEM_PROMPT = (
    ...
    .replace("<GENERATORS_CATALOG>\n</GENERATORS_CATALOG>", GENERATORS_CATALOG)
